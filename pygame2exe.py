...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "squirreleatinglogo.py"

        #Name of program
        self.project_name = "eatinglogo"

        #Project url
        self.project_url = "http://github.com/leemalonzo/eatinglogo"
        ...
        #Description
        self.project_description = "A rat eating logo game credits to GPN Tutor for the 'Game in a Day' workshop"

        #Icon file (None will use pygame default icon)
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ['assets']
